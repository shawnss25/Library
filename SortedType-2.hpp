...
public:
    ...
    ItemType* GetItem(ItemType &item, bool& found, char);
    ...
    void PutItem(ItemType &item, char);
    ...
    void DeleteItem(ItemType &item, char);
    ...
    int GetCurrentItemPos(ItemType, bool&, char);
